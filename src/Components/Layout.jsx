...
export function NavbarList({ulclass, liobject, cartCounter="null", carticonclass="null", svgclass="null"}) {
    return (
        <>
            ...
            <li className={liobject.lithree.clazz}><div><span className={liobject.lithree.span}>{liobject.lithree.spanName}</span></div><NavLink to={liobject.lithree.link} className={liobject.lithree.navlinkClass}>MyGitHub</NavLink></li>
            ...
            <li className={liobject.lifive.clazz}><span className={liobject.lifive.span}>{liobject.lifive.spanName}</span><NavLink to={liobject.lifive.link} className={liobject.lifive.navlinkClass}>Cart</NavLink></li>
            </ul>
        </>
    )
}
