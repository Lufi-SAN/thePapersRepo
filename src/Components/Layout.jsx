            ...
            <header className="sticky top-0" role="header">
                <nav className="flex w-full px-6 py-6 border-b border-b-slate-200 bg-white">
                    ...
                    <ul className="me-0 ms-auto flex text-slate-500">
                        ...
                        <li className="flex items-center gap-x-1"><NavLink to="cart" className="flex items-center h-full"><svg className="h-[16px] h-8 aspect-square" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32" strokeWidth={1.5} stroke="currentColor">
